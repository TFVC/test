    ...
    <div class="content-wrapper">
      <div class="layout-grid">
        ...
        <div class="cards-column">
          <!-- Main Active Card -->
          <div class="achievement-card main-card glass-card active-card slide-in-bottom-3d delay-1">
            ...
            <div class="card-content">
              ...
              <div class="tool-preview">
                <div class="tool-item clickable" @click="$emit('open-tool', 'video-generator')">
                  <video-camera-outlined /> <span>智能视频生成</span>
                </div>
                <div class="tool-item dim">
                  <file-text-outlined /> <span>更多开发中...</span>
                </div>
              </div>
            </div>
          </div>
