...
const handleScroll = (e) => {
  ...
  const scrollPosition = scrollY.value + viewportHeight * 0.5; // Center point
  
  if (scrollPosition < viewportHeight) {
    currentSection.value = 'hero';
  } else if (scrollPosition < viewportHeight * 2) {
    currentSection.value = 'coconstruction';
  } else {
    currentSection.value = 'achievements';
  }
};
