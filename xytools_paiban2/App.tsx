...
const App: React.FC = () => {
  ...
  return (
    <div className="w-screen h-screen overflow-auto bg-slate-50">
      <div className="w-[1280px] h-[720px] mx-auto flex flex-col font-sans selection:bg-emerald-100 bg-white border border-slate-200 shadow-2xl">
          ...
          <div className="grid grid-cols-2 gap-4 h-44 shrink-0">
            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-2 relative">
               <div className="flex items-center justify-between text-[10px] font-black text-slate-400 uppercase tracking-widest">
                  <div className="flex items-center gap-2"><AlignLeft className="w-3 h-3"/>文前引导</div>
            ...
            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-2 relative">
               <div className="flex items-center justify-between text-[10px] font-black text-slate-400 uppercase tracking-widest">
                  <div className="flex items-center gap-2"><AlignLeft className="w-3 h-3"/>文末引导</div>
                  <div className="flex gap-1 overflow-x-auto no-scrollbar max-w-[200px]">
        ...
        <aside className="w-[500px] border-l border-slate-200 bg-white p-6 flex flex-col gap-5 overflow-hidden shrink-0">
           <section className="space-y-3 shrink-0">
             <div className="flex gap-2.5">
                ...
                >
                  <Wand2 className="w-4 h-4 text-indigo-600 group-hover:rotate-12 transition-transform shrink-0" />
                  <div className="text-left">
                    <span className="text-xs font-black block leading-none text-slate-800">智能润色</span>
